...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Compute Black-Scholes option price and Greeks for DIA dataset"
    )
    parser.add_argument(
        "input_csv",
        nargs="?",
        default=str(Path(__file__).resolve().parent / "dia_us_d_with_metrics.csv"),
        help="Path to DIA metrics CSV (default: data/dia_us_d_with_metrics.csv)",
    )
    parser.add_argument(
        "-o",
        "--output",
